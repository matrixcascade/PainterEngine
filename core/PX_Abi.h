...
px_byte* PX_AbiGet_PayloadDataPointer(px_abi* pabi, PX_ABI_TYPE* ptype, px_dword* pdatasize, const px_char _payload[]);
px_byte* PX_AbiGet_PayloadDataPointerWithType(px_abi* pabi, PX_ABI_TYPE type, px_dword* pdatasize, const px_char _payload[]);
