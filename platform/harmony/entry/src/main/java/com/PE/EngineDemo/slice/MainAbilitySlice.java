package com.PE.EngineDemo.slice;
...
public class MainAbilitySlice extends AbilitySlice {
    ...
    static {
        System.loadLibrary("PainterEngineForHarmony");
    }
            ...
            public boolean onTouchEvent(Component component, TouchEvent touchEvent) {
                switch (touchEvent.getAction()) {
                    ...
                    case TouchEvent.PRIMARY_POINT_UP: {
                        MmiPoint point = touchEvent.getPointerPosition(touchEvent.getIndex());
                        onMouseUp((int) point.getX(), (int) point.getY());
                        break;
                    }
    ...
    private class SurfaceCallBack implements SurfaceOps.Callback {
        ...
        public void surfaceCreated(SurfaceOps callbackSurfaceOps) {
            ...
            setSurface( surface,resourceManager);
        }
...
//    }
    ...
    public native void setSurface(Surface surface,ResourceManager resourceMgr);
    public native String stringFromJNI();
    public native void onCreate();
    public native void onDraw();
    public native void onMouseDown(int x,int y);
    public native void onMouseUp(int x,int y);
