...
#define PX_APPLICATION_NAME "PainterEngine"     //应用程序名称
#define PX_APPLICATION_SURFACE_SIZE 680         //
//内存池大小定义
#define PX_APPLICATION_MEMORYPOOL_UI_SIZE 1024*1024*16      //16m
#define PX_APPLICATION_MEMORYPOOL_RESOURCES_SIZE 1024*1024*96   //96m
#define PX_APPLICATION_MEMORYPOOL_GAME_SIZE 1024*1024*8     //8m
