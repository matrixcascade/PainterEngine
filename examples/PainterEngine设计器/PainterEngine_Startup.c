...
px_bool PX_ApplicationInitializeDefault(PX_Runtime *runtime, px_int screen_width, px_int screen_height)
{
	...
	if (PX_APPLICATION_SURFACE_WIDTH==0||PX_APPLICATION_SURFACE_HEIGHT==0)
	{
	...
	if (PX_APPLICATION_WINDOW_WIDTH==0||PX_APPLICATION_WINDOW_HEIGHT==0)
	{
	...
	{
		window_width=PX_APPLICATION_WINDOW_WIDTH;
		window_height=PX_APPLICATION_WINDOW_HEIGHT;
	}
