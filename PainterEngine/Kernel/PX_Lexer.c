...
static px_char * PX_LexerIsCommentStart(px_lexer *lexer,px_char ch[]);
static px_char * PX_LexerIsCommentEnd(px_lexer *lexer,px_char startch[],px_char ch[]);
static px_char* PX_LexerIsContainerStart(px_lexer *lexer,px_char ch[]);
static char*  PX_LexerIsContainerEnd(px_lexer *lexer,px_char startch[],px_char ch[]);
static px_bool PX_LexerIsContainerTransfer(px_lexer *lexer,px_char startch[],px_char ch);
...
px_char * PX_LexerIsCommentStart(px_lexer *lexer,px_char ch[])
{
	px_int i=0;
...
px_char * PX_LexerIsCommentEnd(px_lexer *lexer,px_char startch[],px_char ch[])
{
	px_int i=0;
	for (i=0;i<lexer->CommentCount;i++)
	{
...
px_uint PX_LexerRegisterContainer(px_lexer *lexer,px_char Begin[],px_char End[])
{
	px_int i;
...
px_char * PX_LexerIsContainerStart(px_lexer *lexer,px_char chr[])
{
	px_int i=0;
	for (i=0;i<lexer->ContainerCount;i++)
	{
...
px_char * PX_LexerIsContainerEnd(px_lexer *lexer,px_char startch[],px_char ch[])
{
	px_int i=0;
	for (i=0;i<lexer->ContainerCount;i++)
	{
...
px_bool PX_LexerSortText(px_lexer *lexer,px_char *SourceText)
{
	px_char *chrst,*chred;
...
px_void PX_LexerRegisterComment(px_lexer *lexer, px_char Begin[],px_char End[] )
{
	px_int i;
...
px_int PX_LexerLoadSourceFromMemory(px_lexer *lexer,px_char *buffer)
{
...
px_bool PX_LexerSetSourcePointer(px_lexer *lexer,px_char *buffer)
{
	lexer->Sources=buffer;
	return PX_TRUE;
}
...
px_bool PX_LexerIsContainerTransfer(px_lexer *lexer,px_char startch[],px_char ch)
{
	px_int i=0;
	for (i=0;i<lexer->ContainerCount;i++)
	{
