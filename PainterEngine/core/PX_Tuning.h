...
{
	px_memorypool *mp;
	px_double previous_frame[PX_TUNING_MAX_EXECUTE_SIZE/2*3];
	px_double half_previous_out[PX_TUNING_MAX_EXECUTE_SIZE/2];
	px_double filter[PX_TUNING_MAX_EXECUTE_SIZE];
	px_double window[PX_TUNING_MAX_EXECUTE_SIZE];
	px_double fix[PX_TUNING_MAX_EXECUTE_SIZE];
	...
	px_double lastphase[PX_TUNING_MAX_EXECUTE_SIZE];
	px_int N;
}PX_Tuning;
...
typedef enum
{
	...
	PX_TUNING_WINDOW_SIZE_4096,
	PX_TUNING_WINDOW_SIZE_8192,
