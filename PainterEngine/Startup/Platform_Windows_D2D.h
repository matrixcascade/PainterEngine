...
extern HWND PX_GetWindowHwnd(void);
extern VOID PX_SystemReadDeviceState(void);
extern BOOL PX_SystemLoop(void);
extern BOOL PX_SystemRender(void *raw, int width, int height);
extern BOOL PX_SystemIsActivated(void);
extern BOOL PX_KeyboardDown(unsigned char X);
extern char *PX_KeyboardString(void);
extern char *PX_DragfileString(void);
extern BOOL PX_MouseLButtonDown(void);
extern BOOL PX_MouseRButtonDown(void);
extern BOOL PX_MouseMButtonDown(void);
extern POINT PX_MousePosition(void);
