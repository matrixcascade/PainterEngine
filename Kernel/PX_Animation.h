...
px_void PX_AnimationRenderEx(px_surface *psurface,px_animation *animation,px_point position,PX_TEXTURERENDER_REFPOINT refPoint,PX_TEXTURERENDER_BLEND *blend,px_float scale,px_float rotation);
