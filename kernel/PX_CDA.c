...
PX_Object* PX_CDA_CreateClassObjectEx(PX_CDA* pCDA, px_char classname[], px_float grid_x, px_float grid_y)
{
	...
	if (pObjectClass)
	{
		...
		if (pObjectClass->vmbin.usedsize)
		{
			...
			{
				PX_VMRegisterHostFunction(&pDesc->vm, "sleep", PX_CDA_ObjectVM_Sleep, pObject);//Sleep
				PX_VMRegisterHostFunction(&pDesc->vm, "rand", PX_CDA_ObjectVM_Rand, pObject);//Rand
				PX_VMRegisterHostFunction(&pDesc->vm, "sin", PX_CDA_ObjectVM_Sin, pObject);//Sin
				PX_VMRegisterHostFunction(&pDesc->vm, "cos", PX_CDA_ObjectVM_Cos, pObject);//Cos
				PX_VMRegisterHostFunction(&pDesc->vm, "sqrt", PX_CDA_ObjectVM_Sqrt, pObject);//sqrt
				PX_VMRegisterHostFunction(&pDesc->vm, "getCDAsize", PX_CDA_ObjectVM_GetCDASize, pObject);//getCDAsize
				PX_VMRegisterHostFunction(&pDesc->vm, "getobjectname", PX_CDA_ObjectVM_GetObjectName, pObject);//getobjectname
				PX_VMRegisterHostFunction(&pDesc->vm, "setobjectname", PX_CDA_ObjectVM_SetObjectName, pObject);//setobjectname
				PX_VMRegisterHostFunction(&pDesc->vm, "setobjectposition", PX_CDA_ObjectVM_SetObjectPosition, pObject);//setobjectvelocity
				PX_VMRegisterHostFunction(&pDesc->vm, "getobjectposition", PX_CDA_ObjectVM_GetObjectPosition, pObject);//setobjectvelocity
				...
				PX_VMRegisterHostFunction(&pDesc->vm, "getportfloat", PX_CDA_ObjectVM_GetPortFloat, pObject);//getportfloat
				PX_VMRegisterHostFunction(&pDesc->vm, "setportfloat", PX_CDA_ObjectVM_SetPortFloat, pObject);//setportfloat
				PX_VMRegisterHostFunction(&pDesc->vm, "getportstring", PX_CDA_ObjectVM_GetPortString, pObject);//getportstring
				PX_VMRegisterHostFunction(&pDesc->vm, "setportstring", PX_CDA_ObjectVM_SetPortString, pObject);//setportstring
				PX_VMRegisterHostFunction(&pDesc->vm, "getportmemory", PX_CDA_ObjectVM_GetPortMemory, pObject);//getportmemory
				PX_VMRegisterHostFunction(&pDesc->vm, "setportmemory", PX_CDA_ObjectVM_SetPortMemory, pObject);//setportmemory
				PX_VMRegisterHostFunction(&pDesc->vm, "playanimation", PX_CDA_ObjectVM_PlayAnimation, pObject);//getportpoint
