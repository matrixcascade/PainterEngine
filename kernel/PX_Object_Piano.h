...
typedef struct 
{
	...
	PX_Object* label_mult_density_string, *sliderbar_mult_density_string;//1 string density multiplier.
	PX_Object* label_mult_modulus_string, *sliderbar_mult_modulus_string;//1 young modulus multiplier.
	PX_Object* label_mult_impedance_bridge, *sliderbar_mult_impedance_bridge;//1 bridge impedance multiplier.
	PX_Object* label_mult_impedance_hammer, *sliderbar_mult_impedance_hammer;//0 hammer impedance multiplier.
	PX_Object* label_mult_mass_hammer, *sliderbar_mult_mass_hammer;//1 mass hammer multiplier.
	PX_Object* label_mult_force_hammer, *sliderbar_mult_force_hammer;//0.2 	force hammer multiplier.
	PX_Object* label_mult_hysteresis_hammer, *sliderbar_mult_hysteresis_hammer;//1 hysteresys hammer multiplier.
	PX_Object* label_mult_stiffness_exponent_hammer, *sliderbar_mult_stiffness_exponent_hammer;//1  stiffness_exponent_hammer multiplier.
