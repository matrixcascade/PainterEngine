...
PX_Object_VirtualKeyBoard *PX_Object_GetVirtualKeyBoard(PX_Object *pObject)
{
	...
	{
		return PX_ObjectGetDesc(PX_Object_VirtualKeyBoard,pObject);
	}
	return PX_NULL;
}
...
px_void PX_Object_VirtualKeyBoardRender(px_surface *psurface, PX_Object *pObject,px_uint elapsed)
{
	...
	px_int oftx;
	px_int ofty;
	PX_Object_VirtualKeyBoard *keyBoard=PX_ObjectGetDesc(PX_Object_VirtualKeyBoard,pObject);
...
px_void PX_Object_VirtualKeyBoardOnCursorUp(PX_Object *pObject,PX_Object_Event e,px_void *ptr)
{
	...
	px_int i;
	PX_Object_VirtualKeyBoard *pkb=PX_ObjectGetDesc(PX_Object_VirtualKeyBoard,pObject);
...
PX_Object_VirtualNumberKeyBoard *PX_Object_GetVirtualNumberKeyBoard(PX_Object *pObject)
{
	...
	{
		return PX_ObjectGetDesc(PX_Object_VirtualNumberKeyBoard,pObject);
	}
	return PX_NULL;
}
